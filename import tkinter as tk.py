...
# -------------------------------
root = tk.Tk()
root.title("Control de Finanzas")
...
label_idioma = tk.Label(frame_idioma, bg="#3d191f", fg="white", width=10)
...
# Tipo
label_tipo = tk.Label(frame, bg="#e90a2f", fg="white")
...
# Descripción
label_desc = tk.Label(frame, bg="#df0b2b", fg="white")
...
# Monto
label_monto = tk.Label(frame, bg="#d40e2f", fg="white")
...
login_window.config(bg="#f50c32")

tk.Label(login_window, text="Usuario", bg="#e70a2f", fg="white").pack(pady=5)
entry_usuario = tk.Entry(login_window)
entry_usuario.pack()

tk.Label(login_window, text="Contraseña", bg="#f00930", fg="white").pack(pady=5)
entry_contraseña = tk.Entry(login_window, show="*")
entry_contraseña.pack()

tk.Button(login_window, text="Login", command=verificar_login).pack(pady=15)

# -------------------------------
# Inicializar idioma y mostrar datos
# -------------------------------
cambiar_idioma("in")
mostrar_datos()
